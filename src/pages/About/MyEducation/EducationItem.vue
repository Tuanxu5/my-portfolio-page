...
<template>
    <div class="flex flex-col gap-3 mt-5">
        <div class="flex justify-between items-center">
            <p class="text-[24px] font-bold">Hung Yen University of Technology and Education</p>
            <p class="text-[13px] text-[#1fa9ff]">August 2019 - June 2023</p>
        </div>
        <div class="flex flex-col gap-2">
            <div class="flex gap-2 items-center">
                <div></div>
                <span class="font-bold text-[#1fa9ff]">
            ...
            <div class="flex gap-2 items-center">
                ...
                <p class="text-[16px]">
                    I completed my studies with a GPA of 3.1/4.0.
                </p>
            </div>
        </div>
    </div>
